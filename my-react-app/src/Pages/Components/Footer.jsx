        ...
        <MDBContainer className="text-center text-md-start mt-5">
          <MDBRow className="mt-3">
            <MDBCol md="3" lg="4" xl="3" className="mx-auto mb-4">
              ...
              <p>
                Oran is a coastal city in northwestern Algeria. It's the
                country's second-largest port and a significant economic and
                cultural hub. With a rich history dating back centuries.
              </p>
            </MDBCol>
